...
export default async () => {
  const [vFunhouse, vAcropolis, vSuperstarArena, vHDCenter]: Venue[] = await Venue.bulkCreate([{
    address: '123 Main St',
    city: 'Austin',
    lat: 123456789,
    lng: 987654321,
  ...
  const [sgRock, sgEdm, sgHoliday, sgStandup, sgFootball, sgMotorAuto, sgYoga]: Genre[] = await Genre.bulkCreate([{
    name: 'Rock',
    parentId: gMusic.id,
  }, {
    name: 'EDM',
